...
cl::opt<bool> O_include_pybind11_eigen("include-pybind11-eigen", cl::desc("When specified bindings for Eigen classes in <pybind11/eigen.h> will be used instead of generating custom eigen bindings."),
					 cl::init(false), cl::cat(BinderToolCategory));
